...
const int colorPairs[8][2] = {
  ...
  {COLOR_RED, COLOR_CYAN},      // 旧2: 赤+シアン
  //{COLOR_CYAN, COLOR_RED},      // 2: 赤+シアン
  {COLOR_LOWBLUE, COLOR_RED},   // 3: 薄い青+赤
  {COLOR_LOWBLUE, COLOR_LOWGREEN},// 4: 薄い青+薄い緑
  {COLOR_LOWBLUE, COLOR_CYAN},  // 旧5: 薄い青+シアン
  //{COLOR_CYAN, COLOR_LOWBLUE},  // 5: 薄い青+シアン
...
const int INTERVAL_DURATION = 200;  // 色間の消灯時間
